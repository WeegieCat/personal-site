...
export default function Hero() {
    return (
        <section className='relative overflow-hidden bg-hero-bg'>
            <div className='relative mx-auto min-h-[92vh] w-full max-w-6xl px-6 py-8 sm:px-10 sm:py-12'>
                ...
                <div
                    aria-hidden='true'
                    className='relative z-10 mx-auto mt-20 flex max-w-4xl -rotate-6 flex-col items-center gap-1 sm:mt-28'>
